...
class HistoryWithoutItemPage extends StatefulWidget {
  final AttendanceHistoryModel distributor;

  HistoryWithoutItemPage({required this.distributor, Key? key})
      : super(key: key);

  @override
  State<HistoryWithoutItemPage> createState() => _HistoryWithoutItemPageState();
}

class _HistoryWithoutItemPageState extends State<HistoryWithoutItemPage> {
          ...
          return Center(
            child: Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  String? id = widget.distributor.id;
          ...
          return Padding(
            ...
            child: Center(
              child: Column(
                children: [
                  Text(
                    widget.distributor.distributor!.name,
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        widget.distributor.clock_in!.substring(0, 5),

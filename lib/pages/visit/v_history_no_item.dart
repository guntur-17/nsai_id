...
class VisitingNoItem extends StatefulWidget {
  final VisitingHistoryModel visiting;
  final longUser;
  final latUser;
  ...
  @override
  State<VisitingNoItem> createState() => _VisitPageState();
}

class _VisitPageState extends State<VisitingNoItem> {
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(widget.visiting.clock_in!.substring(0, 5),
